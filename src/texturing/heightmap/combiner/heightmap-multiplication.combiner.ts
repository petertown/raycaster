...
export function heightmapMultiplicationCombiner(heightMap1: number[][], heightMap2: number[][]) {
  let heightmapWidth = heightMap1.length;
  let heightmapHeight = heightMap1[0].length;

  // Create a new heightmap which is the two of those multiplied together
